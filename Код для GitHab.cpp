//Решение пары задач из списка заданий по куру Литкод для загрузки на гитхаб
//Задание: Given an array of characters chars, compress it using the following algorithm:
